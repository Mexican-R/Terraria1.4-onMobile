...
namespace Terraria.Graphics.Shaders
{
	public class ScreenShaderData : ShaderData
	{
		...
		public override void Apply()
		{
			...
			base.Shader.Parameters["uTargetPosition"].SetValue(_uTargetPosition - value);
		...
		{
			_uAssetImages[index] = Main.Assets.Request<Texture2D>(path, Main.content, (AssetRequestMode)1);
