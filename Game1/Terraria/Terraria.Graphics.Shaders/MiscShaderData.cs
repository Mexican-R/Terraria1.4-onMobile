...
namespace Terraria.Graphics.Shaders
{
	public class MiscShaderData : ShaderData
	{
		...
		{
			_uImage0 = Main.Assets.Request<Texture2D>(path, Main.content, (AssetRequestMode)1);
			return this;
		}

		public MiscShaderData UseImage1(string path)
		{
			_uImage1 = Main.Assets.Request<Texture2D>(path, Main.content, (AssetRequestMode)1);
			return this;
		}

		public MiscShaderData UseImage2(string path)
		{
			_uImage2 = Main.Assets.Request<Texture2D>(path, Main.content, (AssetRequestMode)1);
			return this;
		}
