...
namespace Terraria.GameContent.UI.States
{
	public class UIManageControls : UIState
	{
		...
		{
			_KeyboardGamepadTexture = Main.Assets.Request<Texture2D>("Images/UI/Settings_Inputs", Main.content, (AssetRequestMode)1);
			_keyboardGamepadBorderTexture = Main.Assets.Request<Texture2D>("Images/UI/Settings_Inputs_Border", Main.content, (AssetRequestMode)1);
			_GameplayVsUITexture = Main.Assets.Request<Texture2D>("Images/UI/Settings_Inputs_2", Main.content, (AssetRequestMode)1);
			_GameplayVsUIBorderTexture = Main.Assets.Request<Texture2D>("Images/UI/Settings_Inputs_2_Border", Main.content, (AssetRequestMode)1);
