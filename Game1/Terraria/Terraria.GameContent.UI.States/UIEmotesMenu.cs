...
namespace Terraria.GameContent.UI.States
{
	public class UIEmotesMenu : UIState
	{
		...
		public void InitializePage()
		{
			...
			TryAddingList(Language.GetText("UI.EmoteCategoryGeneral"), currentGroupIndex, 10, GetEmotesGeneral());
			TryAddingList(Language.GetText("UI.EmoteCategoryRPS"), currentGroupIndex, 10, GetEmotesRPS());
			TryAddingList(Language.GetText("UI.EmoteCategoryItems"), currentGroupIndex, 11, GetEmotesItems());
			TryAddingList(Language.GetText("UI.EmoteCategoryBiomesAndEvents"), currentGroupIndex, 8, GetEmotesBiomesAndEvents());
			TryAddingList(Language.GetText("UI.EmoteCategoryTownNPCs"), currentGroupIndex, 9, GetEmotesTownNPCs());
			TryAddingList(Language.GetText("UI.EmoteCategoryCritters"), currentGroupIndex, 7, GetEmotesCritters());
			TryAddingList(Language.GetText("UI.EmoteCategoryBosses"), currentGroupIndex, 8, GetEmotesBosses());
		}
