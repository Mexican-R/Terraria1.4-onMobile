...
namespace Terraria.GameContent.UI.States
{
	public class UIBestiaryTest : UIState
	{
		...
		{
			UIImageButton uIImageButton = new UIImageButton(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Button_Back", Main.content, (AssetRequestMode)1));
			uIImageButton.SetHoverImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Button_Border", Main.content, (AssetRequestMode)1));
			...
			UIImageButton uIImageButton2 = new UIImageButton(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Button_Forward", Main.content, (AssetRequestMode)1))
			{
				Left = new StyleDimension(uIImageButton.Width.Pixels + 1f, 0f)
			};
			uIImageButton2.SetHoverImage(Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Button_Border", Main.content, (AssetRequestMode)1));
		...
		private void SetupGamepadPoints(SpriteBatch spriteBatch)
		{
			...
			if (_filteringGrid.Parent != null)
			{
				SetupPointsForFilterGrid(currentID, snapPoints, out gridWidth, out gridHeight, out gridPoints);
			...
			{
				SetupPointsForSortingGrid(currentID, snapPoints, out gridWidth, out gridHeight, out gridPoints);
				PairUpDown(uILinkPoint2, uILinkPoint3);
				PairUpDown(uILinkPoint, uILinkPoint3);
			...
			{
				SetupPointsForEntryGrid(currentID, snapPoints, out gridWidth, out gridHeight, out gridPoints);
		...
		private void SetupPointsForEntryGrid(int currentID, List<SnapPoint> pts, out int gridWidth, out int gridHeight, out UILinkPoint[,] gridPoints)
		{
		...
		private void SetupPointsForFilterGrid(int currentID, List<SnapPoint> pts, out int gridWidth, out int gridHeight, out UILinkPoint[,] gridPoints)
		{
