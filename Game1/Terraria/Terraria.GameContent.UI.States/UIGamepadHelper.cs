...
namespace Terraria.GameContent.UI.States
{
	...
	{
		public UILinkPoint[,] CreateUILinkPointGrid(int currentID, List<SnapPoint> pointsForGrid, int pointsPerLine, UILinkPoint topLinkPoint, UILinkPoint leftLinkPoint)
		{
		...
		public UILinkPoint[] CreateUILinkStripVertical(int currentID, List<SnapPoint> currentStrip)
		{
		...
		public UILinkPoint[] CreateUILinkStripHorizontal(int currentID, List<SnapPoint> currentStrip)
		{
			UILinkPoint[] array = new UILinkPoint[currentStrip.Count];
			for (int i = 0; i < currentStrip.Count; i++)
			{
		...
		public UILinkPoint[] GetVerticalStripFromCategoryName(int currentID, List<SnapPoint> pts, string categoryName)
		{
			...
			{
				result = CreateUILinkStripVertical(currentID, orderedPointsByCategoryName);
			}
			return result;
		}
