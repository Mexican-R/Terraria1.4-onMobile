...
namespace Terraria.GameContent.UI.States
{
	public class UIResourcePackSelectionMenu : UIState
	{
		...
		private UIElement CreatePackInfoButton(ResourcePack resourcePack)
		{
			...
			UIImage element = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/CharCreation/CharInfo", Main.content, (AssetRequestMode)1))
			{
				HAlign = 0.5f,
				VAlign = 0.5f,
				IgnoresMouseInteraction = true
		...
		private void SetupGamepadPoints(SpriteBatch spriteBatch)
		{
			...
			UILinkPoint[] verticalStripFromCategoryName = _helper.GetVerticalStripFromCategoryName(currentID, snapPoints2, "ToggleToOn");
			UILinkPoint[] verticalStripFromCategoryName2 = _helper.GetVerticalStripFromCategoryName(currentID, snapPoints2, "InfoOff");
			UILinkPoint[] verticalStripFromCategoryName3 = _helper.GetVerticalStripFromCategoryName(currentID, snapPoints3, "ToggleToOff");
			UILinkPoint[] verticalStripFromCategoryName4 = _helper.GetVerticalStripFromCategoryName(currentID, snapPoints3, "InfoOn");
			UILinkPoint[] verticalStripFromCategoryName5 = _helper.GetVerticalStripFromCategoryName(currentID, snapPoints3, "OrderUp");
			UILinkPoint[] verticalStripFromCategoryName6 = _helper.GetVerticalStripFromCategoryName(currentID, snapPoints3, "OrderDown");
