...
namespace Terraria.GameContent.UI.States
{
	public class UICharacterCreation : UIState
	{
		...
		private void MakeClothStylesMenu(UIElement middleInnerPanel)
		{
			...
			UIColoredImageButton uIColoredImageButton2 = new UIColoredImageButton(Main.Assets.Request<Texture2D>("Images/UI/CharCreation/Copy", Main.content, (AssetRequestMode)1), isSmall: true)
			{
				VAlign = 0.5f,
				HAlign = 0f,
			...
			UIColoredImageButton uIColoredImageButton3 = new UIColoredImageButton(Main.Assets.Request<Texture2D>("Images/UI/CharCreation/Paste", Main.content, (AssetRequestMode)1), isSmall: true)
			{
				VAlign = 0.5f,
				HAlign = 0.5f
			};
			...
			UIColoredImageButton uIColoredImageButton4 = new UIColoredImageButton(Main.Assets.Request<Texture2D>("Images/UI/CharCreation/Randomize", Main.content, (AssetRequestMode)1), isSmall: true)
			{
				VAlign = 0.5f,
				HAlign = 1f
			};
		...
		private void MakeCategoriesBar(UIElement categoryContainer)
		{
			...
			_colorPickers[4].SetMiddleTexture(Main.Assets.Request<Texture2D>("Images/UI/CharCreation/ColorEyeBack", Main.content, (AssetRequestMode)1));
			...
			_hairStylesCategoryButton.SetMiddleTexture(Main.Assets.Request<Texture2D>("Images/UI/CharCreation/HairStyle_Arrow", Main.content, (AssetRequestMode)1));
		...
		{
			UIColoredImageButton uIColoredImageButton = new UIColoredImageButton(Main.Assets.Request<Texture2D>(texturePath, Main.content, (AssetRequestMode)1));
		...
		private void MakeInfoMenu(UIElement parentContainer)
		{
			...
			uIDifficultyButton.SetSnapPoint("Middle", 1);
			uIDifficultyButton2.SetSnapPoint("Middle", 2);
			uIDifficultyButton3.SetSnapPoint("Middle", 3);
			uIDifficultyButton4.SetSnapPoint("Middle", 4);
		}
		...
		private void MakeHSLMenu(UIElement parentContainer)
		{
			...
			uIElement.Append(uIPanel);
			UIColoredImageButton uIColoredImageButton = new UIColoredImageButton(Main.Assets.Request<Texture2D>("Images/UI/CharCreation/Copy", Main.content, (AssetRequestMode)1), isSmall: true)
			{
				VAlign = 1f,
				HAlign = 0f,
				Left = StyleDimension.FromPixelsAndPercent(0f, 0f)
			...
			UIColoredImageButton uIColoredImageButton2 = new UIColoredImageButton(Main.Assets.Request<Texture2D>("Images/UI/CharCreation/Paste", Main.content, (AssetRequestMode)1), isSmall: true)
			{
				VAlign = 1f,
				HAlign = 0f,
			...
			UIColoredImageButton uIColoredImageButton3 = new UIColoredImageButton(Main.Assets.Request<Texture2D>("Images/UI/CharCreation/Randomize", Main.content, (AssetRequestMode)1), isSmall: true)
			{
				VAlign = 1f,
				HAlign = 0f,
		...
		{
			_clothingStylesCategoryButton.SetImage(Main.Assets.Request<Texture2D>("Images/UI/CharCreation/" + (_player.Male ? "ClothStyleMale" : "ClothStyleFemale"), Main.content, (AssetRequestMode)1));
			UpdateSelectedGender();
		}
		...
		{
			SoundEngine.PlaySound(12);
			string value = "nmsl";//Platform.Get<IClipboard>().Value;
		...
		private void Click_CopyPlayerTemplate(UIMouseEvent evt, UIElement listeningElement)
		{
			...
			PlayerInput.PrettyPrintProfiles(text);
