...
namespace Terraria.ID
{
	public static class Colors
	{
		...
		{
			return isTileSelected ? new Color(averageTileLighting, averageTileLighting, averageTileLighting / 3, averageTileLighting) : new Color(averageTileLighting / 2, averageTileLighting / 2, averageTileLighting / 2, averageTileLighting);
		}
	}
}
