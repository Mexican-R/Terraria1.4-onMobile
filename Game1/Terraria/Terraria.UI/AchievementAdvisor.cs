...
namespace Terraria.UI
{
	public class AchievementAdvisor
	{
		...
		{
			_achievementsTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievements", Main.content, (AssetRequestMode)1);
			_achievementsBorderTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders", Main.content, (AssetRequestMode)1);
			_achievementsBorderMouseHoverFatTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders_MouseHover", Main.content, (AssetRequestMode)1);
			_achievementsBorderMouseHoverThinTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders_MouseHoverThin", Main.content, (AssetRequestMode)1);
		}
		...
		private void DrawCard(AchievementAdvisorCard card, SpriteBatch spriteBatch, Vector2 position, float scale, out bool hovered)
		{
			...
			Texture2D value3 = _achievementsBorderMouseHoverFatTexture.Value;
			if (scale > 0.5f)
			{
				value3 = _achievementsBorderMouseHoverThinTexture.Value;
