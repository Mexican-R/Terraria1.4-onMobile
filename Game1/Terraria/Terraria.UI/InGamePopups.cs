	...
	public class InGamePopups
	{
		public class AchievementUnlockedPopup : IInGameNotification
		{
			...
			public AchievementUnlockedPopup(Achievement achievement)
			{
				...
				_achievementTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievements", Main.content, (AssetRequestMode)2);
				_achievementBorderTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders", Main.content, (AssetRequestMode)2);
			}
		...
		public class PlayerWantsToJoinGamePopup : IInGameNotification
		{
			...
			public void DrawInGame(SpriteBatch spriteBatch, Vector2 bottomAnchorPosition)
			{
				...
				if (opacity > 0f)
				{
					...
					vector.X += 32f;
					Texture2D value = Main.Assets.Request<Texture2D>("Images/UI/ButtonPlay", Main.content, (AssetRequestMode)1).Value;
					...
					value = Main.Assets.Request<Texture2D>("Images/UI/ButtonDelete", Main.content, (AssetRequestMode)1).Value;
			...
			public void DrawInNotificationsArea(SpriteBatch spriteBatch, Rectangle area, int gamepadPointLocalIndexTouse)
			{
				...
				Utils.TrimTextIfNeeded(text, FontAssets.MouseText.Value, 0.9f, area.Width / 4);
