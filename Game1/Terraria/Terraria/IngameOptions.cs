...
namespace Terraria
{
	public static class IngameOptions
	{
		...
		public static void Draw(Main mainInstance, SpriteBatch sb)
		{
			...
			int num4 = 20;
			_GUIHover = new Rectangle((int)(value3.X - (float)num4), (int)(value3.Y - (float)num4), (int)(value2.X + (float)(num4 * 2)), (int)(value2.Y + (float)(num4 * 2)));
			Utils.DrawInvBG(sb, value3.X - (float)num4, value3.Y - (float)num4, value2.X + (float)(num4 * 2), value2.Y + (float)(num4 * 2), new Color(33, 15, 91, 255) * 0.685f);
			if (new Rectangle((int)value3.X - num4, (int)value3.Y - num4, (int)value2.X + num4 * 2, (int)value2.Y + num4 * 2).Contains(new Point(Main.mouseX, Main.mouseY)))
			{
				Main.player[Main.myPlayer].mouseInterface = true;
			}
			Utils.DrawBorderString(sb, Language.GetTextValue("GameUI.SettingsMenu"), value3 + value2 * new Vector2(0.5f, 0f), Color.White, 1f, 0.5f);
			if (flag)
			{
				Utils.DrawInvBG(sb, value3.X + (float)(num4 / 2), value3.Y + (float)(num4 * 5 / 2), value2.X / 3f - (float)num4, value2.Y - (float)(num4 * 3));
				Utils.DrawInvBG(sb, value3.X + value2.X / 3f + (float)num4, value3.Y + (float)(num4 * 5 / 2), value2.X * 2f / 3f - (float)(num4 * 3 / 2), value2.Y - (float)(num4 * 3));
			}
			else
			{
				Utils.DrawInvBG(sb, value3.X + (float)(num4 / 2), value3.Y + (float)(num4 * 5 / 2), value2.X / 2f - (float)num4, value2.Y - (float)(num4 * 3));
				Utils.DrawInvBG(sb, value3.X + value2.X / 2f + (float)num4, value3.Y + (float)(num4 * 5 / 2), value2.X / 2f - (float)(num4 * 3 / 2), value2.Y - (float)(num4 * 3));
			}
			float num5 = 0.7f;
			float num6 = 0.8f;
			float num7 = 0.01f;
			...
			int num8 = (flag5 ? 1 : 0);
			int num9 = 5 + num8 + 2;
			Vector2 vector = new Vector2(value3.X + value2.X / 4f, value3.Y + (float)(num4 * 5 / 2));
			Vector2 vector2 = new Vector2(0f, value2.Y - (float)(num4 * 5)) / (num9 + 1);
			if (flag)
			{
				vector.X -= 55f;
			}
			...
			{
				bool flag6 = false;
				if (_leftSideCategoryMapping.TryGetValue(j, out var value4))
				{
					flag6 = category == value4;
				}
			...
			int num10 = category;
			int num11 = 0;
			if (DrawLeftSide(sb, Lang.menu[114].Value, num11, vector, vector2, leftScale))
			{
				leftHover = num11;
				if (flag4)
				{
			...
			num11++;
			if (DrawLeftSide(sb, Lang.menu[210].Value, num11, vector, vector2, leftScale))
			{
				leftHover = num11;
				if (flag4)
				{
			...
			num11++;
			if (DrawLeftSide(sb, Lang.menu[63].Value, num11, vector, vector2, leftScale))
			{
				leftHover = num11;
				if (flag4)
				{
			...
			num11++;
			if (DrawLeftSide(sb, Lang.menu[218].Value, num11, vector, vector2, leftScale))
			{
				leftHover = num11;
				if (flag4)
				{
			...
			num11++;
			if (DrawLeftSide(sb, Lang.menu[66].Value, num11, vector, vector2, leftScale))
			{
				leftHover = num11;
				if (flag4)
				{
			...
			num11++;
			if (flag5 && DrawLeftSide(sb, Lang.menu[147].Value, num11, vector, vector2, leftScale))
			{
				leftHover = num11;
				if (flag4)
				{
			...
			if (DrawLeftSide(sb, Lang.menu[131].Value, num11, vector, vector2, leftScale))
			{
				leftHover = num11;
				if (flag4)
				{
			...
			num11++;
			if (DrawLeftSide(sb, Lang.menu[118].Value, num11, vector, vector2, leftScale))
			{
				leftHover = num11;
				if (flag4)
				{
			...
			num11++;
			if (DrawLeftSide(sb, Lang.inter[35].Value, num11, vector, vector2, leftScale))
			{
				leftHover = num11;
				if (flag4)
				{
			...
			Vector2 vector3 = new Vector2(value3.X + value2.X * 3f / 4f, value3.Y + (float)(num4 * 5 / 2));
			Vector2 vector4 = new Vector2(0f, value2.Y - (float)(num4 * 3)) / (num13 + 1);
			if (category == 2)
			{
				vector4.Y -= 2f;
			}
			...
			{
				int num14 = 0;
				DrawRightSide(sb, Lang.menu[65].Value, num14, vector3, vector4, rightScale[num14], 1f);
				skipRightSlot[num14] = true;
				num14++;
				vector3.X -= num;
				if (DrawRightSide(sb, Lang.menu[99].Value + " " + Math.Round(Main.musicVolume * 100f) + "%", num14, vector3, vector4, rightScale[num14], (rightScale[num14] - num5) / (num6 - num5)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				valuePosition.X = value3.X + value2.X - (float)(num4 / 2) - 20f;
				valuePosition.Y -= 3f;
				...
				if ((float)Main.mouseX > value3.X + value2.X * 2f / 3f + (float)num4 && (float)Main.mouseX < valuePosition.X + 3.75f && (float)Main.mouseY > valuePosition.Y - 10f && (float)Main.mouseY <= valuePosition.Y + 10f)
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				num14++;
				if (DrawRightSide(sb, Lang.menu[98].Value + " " + Math.Round(Main.soundVolume * 100f) + "%", num14, vector3, vector4, rightScale[num14], (rightScale[num14] - num5) / (num6 - num5)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				num14++;
				if (DrawRightSide(sb, Lang.menu[119].Value + " " + Math.Round(Main.ambientVolume * 100f) + "%", num14, vector3, vector4, rightScale[num14], (rightScale[num14] - num5) / (num6 - num5)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				num14++;
				vector3.X += num;
				DrawRightSide(sb, "", num14, vector3, vector4, rightScale[num14], 1f);
				skipRightSlot[num14] = true;
				num14++;
				DrawRightSide(sb, Language.GetTextValue("GameUI.ZoomCategory"), num14, vector3, vector4, rightScale[num14], 1f);
				skipRightSlot[num14] = true;
				num14++;
				vector3.X -= num;
				...
				if (DrawRightSide(sb, text, num14, vector3, vector4, rightScale[num14] * 0.85f, (rightScale[num14] - num5) / (num6 - num5)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				if (DrawRightSide(sb, text2, num14, vector3, vector4, rightScale[num14] * 0.75f, (rightScale[num14] - num5) / (num6 - num5)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				skipRightSlot[num14] = true;
				num14++;
				DrawRightSide(sb, Language.GetTextValue("GameUI.Gameplay"), num14, vector3, vector4, rightScale[num14], 1f);
				skipRightSlot[num14] = true;
				num14++;
				if (DrawRightSide(sb, Main.autoSave ? Lang.menu[67].Value : Lang.menu[68].Value, num14, vector3, vector4, rightScale[num14], (rightScale[num14] - num5) / (num6 - num5)))
				{
					rightHover = num14;
					if (flag4)
					{
				...
				num14++;
				if (DrawRightSide(sb, Main.autoPause ? Lang.menu[69].Value : Lang.menu[70].Value, num14, vector3, vector4, rightScale[num14], (rightScale[num14] - num5) / (num6 - num5)))
				{
					rightHover = num14;
					if (flag4)
					{
				...
				num14++;
				if (DrawRightSide(sb, Main.ReversedUpDownArmorSetBonuses ? Lang.menu[220].Value : Lang.menu[221].Value, num14, vector3, vector4, rightScale[num14], (rightScale[num14] - num5) / (num6 - num5)))
				{
					rightHover = num14;
					if (flag4)
					{
				...
				}, num14, vector3, vector4, rightScale[num14], (rightScale[num14] - num5) / (num6 - num5)))
				{
					rightHover = num14;
					if (flag4)
					{
				...
				if (DrawRightSide(sb, textValue, num14, vector3, vector4, rightScale[num14], (rightScale[num14] - num5) / (num6 - num5)))
				{
					rightHover = num14;
					if (flag4)
					{
			...
			{
				int num17 = 0;
				if (DrawRightSide(sb, Main.showItemText ? Lang.menu[71].Value : Lang.menu[72].Value, num17, vector3, vector4, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
				...
				num17++;
				if (DrawRightSide(sb, Lang.menu[123].Value + " " + Lang.menu[124 + Main.invasionProgressMode], num17, vector3, vector4, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
				...
				num17++;
				if (DrawRightSide(sb, Main.placementPreview ? Lang.menu[128].Value : Lang.menu[129].Value, num17, vector3, vector4, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
				...
				num17++;
				if (DrawRightSide(sb, ItemSlot.Options.HighlightNewItems ? Lang.inter[117].Value : Lang.inter[116].Value, num17, vector3, vector4, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
				...
				num17++;
				if (DrawRightSide(sb, Main.MouseShowBuildingGrid ? Lang.menu[229].Value : Lang.menu[230].Value, num17, vector3, vector4, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
				...
				num17++;
				if (DrawRightSide(sb, Main.GamepadDisableInstructionsDisplay ? Lang.menu[241].Value : Lang.menu[242].Value, num17, vector3, vector4, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
				...
				{
					MinimapFrame value5 = minimapFrame2.Value;
					if (value5 == Main.ActiveMinimapFrame)
					{
				...
				{
					minimapFrame = Main.MinimapFrames.Values.Last();
				}
				if (DrawRightSide(sb, Language.GetTextValue("UI.SelectMapBorder", arg), num17, vector3, vector4, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
				...
				if (DrawRightSide(sb, text3, num17, vector3, vector4, rightScale[num17] * 0.85f, (rightScale[num17] - num5) / (num6 - num5)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				{
					IPlayerResourcesDisplaySet value6 = playerResourcesSet.Value;
					if (value6 == Main.ActivePlayerResourcesSet)
					{
						arg2 = Language.GetTextValue("UI.HealthManaStyle_" + playerResourcesSet.Key);
						break;
					}
					playerResourcesDisplaySet = value6;
				}
				if (playerResourcesDisplaySet == null)
				{
					playerResourcesDisplaySet = Main.PlayerResourcesSets.Values.Last();
				}
				if (DrawRightSide(sb, Language.GetTextValue("UI.SelectHealthStyle", arg2), num17, vector3, vector4, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
				...
				num17++;
				if (DrawRightSide(sb, Main.SettingsEnabled_OpaqueBoxBehindTooltips ? Language.GetTextValue("GameUI.HoverTextBoxesOn") : Language.GetTextValue("GameUI.HoverTextBoxesOff"), num17, vector3, vector4, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
			...
			{
				int num19 = 0;
				if (DrawRightSide(sb, Main.graphics.IsFullScreen ? Lang.menu[49].Value : Lang.menu[50].Value, num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				num19++;
				if (DrawRightSide(sb, Lang.menu[51].Value + ": " + Main.PendingResolutionWidth + "x" + Main.PendingResolutionHeight, num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				num19++;
				vector3.X -= num;
				if (DrawRightSide(sb, Lang.menu[52].Value + ": " + Main.bgScroll + "%", num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				num19++;
				vector3.X += num;
				if (DrawRightSide(sb, Lang.menu[247 + Main.FrameSkipMode].Value, num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				num19++;
				if (DrawRightSide(sb, Language.GetTextValue("UI.LightMode_" + Lighting.Mode), num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				num19++;
				if (DrawRightSide(sb, Lang.menu[59 + Main.qaStyle].Value, num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				num19++;
				if (DrawRightSide(sb, Main.BackgroundEnabled ? Lang.menu[100].Value : Lang.menu[101].Value, num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				num19++;
				if (DrawRightSide(sb, ChildSafety.Disabled ? Lang.menu[132].Value : Lang.menu[133].Value, num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				num19++;
				if (DrawRightSide(sb, Language.GetTextValue("GameUI.HeatDistortion", Main.UseHeatDistortion ? Language.GetTextValue("GameUI.Enabled") : Language.GetTextValue("GameUI.Disabled")), num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				num19++;
				if (DrawRightSide(sb, Language.GetTextValue("GameUI.StormEffects", Main.UseStormEffects ? Language.GetTextValue("GameUI.Enabled") : Language.GetTextValue("GameUI.Disabled")), num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				}), num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				num19++;
				if (DrawRightSide(sb, Language.GetTextValue("UI.TilesSwayInWind" + (Main.SettingsEnabled_TilesSwayInWind ? "On" : "Off")), num19, vector3, vector4, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
			...
			if (category == 3)
			{
				...
				DrawRightSide(sb, Lang.menu[64].Value, num22, vector3, vector4, rightScale[num22], 1f);
				skipRightSlot[num22] = true;
				num22++;
				vector3.X -= num23;
				if (DrawRightSide(sb, "", num22, vector3, vector4, rightScale[num22], (rightScale[num22] - num5) / (num6 - num5)))
				{
					if (rightLock == -1)
					{
						notBar = true;
				...
				vector3.X += num23;
				DrawRightSide(sb, "", num22, vector3, vector4, rightScale[num22], 1f);
				skipRightSlot[num22] = true;
				num22++;
				...
				DrawRightSide(sb, Lang.menu[217].Value, num22, vector3, vector4, rightScale[num22], 1f);
				skipRightSlot[num22] = true;
				num22++;
				vector3.X -= num23;
				if (DrawRightSide(sb, "", num22, vector3, vector4, rightScale[num22], (rightScale[num22] - num5) / (num6 - num5)))
				...
				if (DrawRightSide(sb, txt, num22, vector3, vector4, rightScale[num22] * 0.9f, (rightScale[num22] - num5) / (num6 - num5)))
				{
					rightHover = num22;
					if (flag4)
					{
				...
				num22++;
				if (DrawRightSide(sb, Player.SmartCursorSettings.SmartBlocksEnabled ? Lang.menu[215].Value : Lang.menu[216].Value, num22, vector3, vector4, rightScale[num22] * 0.9f, (rightScale[num22] - num5) / (num6 - num5)))
				{
					rightHover = num22;
					if (flag4)
					{
				...
				num22++;
				if (DrawRightSide(sb, Main.cSmartCursorModeIsToggleAndNotHold ? Lang.menu[121].Value : Lang.menu[122].Value, num22, vector3, vector4, rightScale[num22], (rightScale[num22] - num5) / (num6 - num5)))
				{
					rightHover = num22;
					if (flag4)
					{
				...
				num22++;
				if (DrawRightSide(sb, Player.SmartCursorSettings.SmartAxeAfterPickaxe ? Lang.menu[214].Value : Lang.menu[213].Value, num22, vector3, vector4, rightScale[num22] * 0.9f, (rightScale[num22] - num5) / (num6 - num5)))
				{
					rightHover = num22;
					if (flag4)
					{
			...
			{
				UILinkPointNavigator.SetPosition(2900 + n, vector + vector2 * (n + 1));
			}
			...
			for (int num25 = 0; num25 < num13; num25++)
			{
				...
				{
					UILinkPointNavigator.SetPosition(2930 + num12, vector3 + zero + vector4 * (num25 + 1));
					num12++;
				}
			}
