...
namespace Terraria
{
	public static class Minecart
	{
		...
		public static BitsByte TrackCollision(Vector2 Position, Vector2 Velocity, Vector2 lastBoost, int Width, int Height, bool followDown, bool followUp, int fallStart, bool trackOnly, Mount.MountDelegatesData delegatesData)
		{
		...
		public static float TrackRotation(float rotation, Vector2 Position, int Width, int Height, bool followDown, bool followUp, Mount.MountDelegatesData delegatesData)
		{
		...
		public static void GetWheelsPositions(Vector2 Position, int Width, int Height, bool followDown, bool followUp, Mount.MountDelegatesData delegatesData, out Vector2 leftWheel, out Vector2 rightWheel)
		{
			...
			TrackCollision(leftWheel, Velocity, lastBoost, Width, Height, followDown, followUp, 0, trackOnly: true, delegatesData);
			leftWheel += Velocity;
			Velocity = new Vector2(12f, 0f);
			TrackCollision(rightWheel, Velocity, lastBoost, Width, Height, followDown, followUp, 0, trackOnly: true, delegatesData);
			rightWheel += Velocity;
		}
