	...
	public class Lighting
	{
		...
		public static void GetColor4Slice(int centerX, int centerY, Color[] slices)
		{
			...
			if (num >= num4)
			{
				...
				slices[0] = new Color((int)num5, (int)num6, (int)num7, 255);
			}
			else
			{
				...
				slices[0] = new Color((int)num8, (int)num9, (int)num10, 255);
			}
			if (num >= num3)
			{
				...
				slices[1] = new Color((int)num11, (int)num12, (int)num13, 255);
			}
			else
			{
				...
				slices[1] = new Color((int)num14, (int)num15, (int)num16, 255);
			}
			if (num2 >= num4)
			{
				...
				slices[2] = new Color((int)num17, (int)num18, (int)num19, 255);
			}
			else
			{
				...
				slices[2] = new Color((int)num20, (int)num21, (int)num22, 255);
			}
			if (num2 >= num3)
			{
				...
				slices[3] = new Color((int)num23, (int)num24, (int)num25, 255);
			}
			else
			{
				...
				slices[3] = new Color((int)num26, (int)num27, (int)num28, 255);
			}
		}
