...
namespace Terraria
{
	public class Dust
	{
		...
		public static void UpdateDust()
		{
				...
				if (i < Main.maxDustToDraw)
				{
					...
					if (dust.type == 230)
					{
						...
						if (dust.customData != null && dust.customData is Player)
						{
							...
							Vector2 value = dust.position - center;
							float num13 = value.Length();
							value /= num13;
							dust.scale = Math.Min(dust.scale, num13 / 24f - 1f);
							dust.velocity -= value * (100f / Math.Max(50f, num13));
						}
					}
					...
					else if (dust.type == 160 || dust.type == 162)
					{
						...
						if (dust.type == 162)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num64, num64 * 0.7f, num64 * 0.1f);
						}
						else
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num64 * 0.1f, num64, num64);
						}
						if (dust.noGravity)
						{
							dust.velocity *= 0.8f;
						...
						else
						{
							...
							{
								int num65 = NewDust(new Vector2(dust.position.X - 4f, dust.position.Y - 4f), 1, 1, dust.type);
								Main.dust[num65].noGravity = true;
								Main.dust[num65].scale = dust.scale * 1.5f;
							}
						}
					}
					else if (dust.type == 168)
					{
						float num66 = dust.scale * 0.8f;
						if ((double)num66 > 0.55)
						{
							num66 = 0.55f;
						}
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num66, 0f, num66 * 0.8f);
						dust.scale += 0.03f;
						dust.velocity.X += (float)Main.rand.Next(-10, 11) * 0.02f;
						dust.velocity.Y += (float)Main.rand.Next(-10, 11) * 0.02f;
						dust.velocity *= 0.99f;
					...
					else if (dust.type >= 244 && dust.type <= 247)
					{
						...
						byte num67 = (byte)((color.R + color.G + color.B) / 3);
						float num68 = ((float)(int)num67 / 270f + 1f) / 2f;
						float num69 = ((float)(int)num67 / 270f + 1f) / 2f;
						float num70 = ((float)(int)num67 / 270f + 1f) / 2f;
						num68 *= dust.scale * 0.9f;
						...
						num69 *= num71;
						num70 *= num71;
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num68, num69, num70);
					}
					else if (dust.type == 43)
					{
						dust.rotation += 0.1f * dust.scale;
						Color color2 = Lighting.GetColor((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f));
						float num72 = (float)(int)color2.R / 270f;
						float num73 = (float)(int)color2.G / 270f;
						float num74 = (float)(int)color2.B / 270f;
						float num75 = (float)(int)dust.color.R / 255f;
						float num76 = (float)(int)dust.color.G / 255f;
						float num77 = (float)(int)dust.color.B / 255f;
						num72 *= dust.scale * 1.07f * num75;
						...
						if ((double)num72 < 0.05 && (double)num73 < 0.05 && (double)num74 < 0.05)
						{
							dust.active = false;
						}
					...
					else if (dust.type == 15 || dust.type == 57 || dust.type == 58 || dust.type == 274 || dust.type == 292)
					{
						...
						{
							float num78 = dust.scale;
							if (dust.type != 15)
							{
								num78 = dust.scale * 0.8f;
							}
							if (dust.noLight)
							{
								dust.velocity *= 0.95f;
							...
							if (dust.type == 15)
							{
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num78 * 0.45f, num78 * 0.55f, num78);
							}
							else if (dust.type == 57)
							{
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num78 * 0.95f, num78 * 0.95f, num78 * 0.45f);
							}
							else if (dust.type == 58)
							{
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num78, num78 * 0.55f, num78 * 0.75f);
							}
						}
					}
					...
					{
						float num79 = dust.scale * 0.1f;
						if (num79 > 1f)
						{
							num79 = 1f;
						}
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num79 * 0.2f, num79, num79 * 0.5f);
					}
					else if (dust.type == 111)
					{
						float num80 = dust.scale * 0.125f;
						if (num80 > 1f)
						{
							num80 = 1f;
						}
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num80 * 0.2f, num80 * 0.7f, num80);
					}
					else if (dust.type == 112)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num81 * 0.8f, num81 * 0.2f, num81 * 0.8f);
					}
					else if (dust.type == 113)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num82 * 0.2f, num82 * 0.3f, num82 * 1.3f);
					}
					else if (dust.type == 114)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num83 * 1.2f, num83 * 0.5f, num83 * 0.4f);
					}
					else if (dust.type == 66)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num84 * ((float)(int)dust.color.R / 255f), num84 * ((float)(int)dust.color.G / 255f), num84 * ((float)(int)dust.color.B / 255f));
					}
					else if (dust.type == 267)
					{
						...
						if (!dust.noLight && !dust.noLightEmittence)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num85 * ((float)(int)dust.color.R / 255f), num85 * ((float)(int)dust.color.G / 255f), num85 * ((float)(int)dust.color.B / 255f));
						}
					}
					else if (dust.type == 20 || dust.type == 21 || dust.type == 231)
					{
						...
						{
							num86 = dust.scale * 0.4f;
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num86 * 0.8f, num86 * 0.3f, num86);
						}
						else if (dust.type == 231)
						{
							num86 = dust.scale * 0.4f;
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num86, num86 * 0.5f, num86 * 0.3f);
						}
						else
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num86 * 0.3f, num86 * 0.6f, num86);
						}
					}
					else if (dust.type == 27 || dust.type == 45)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num87 * 0.6f, num87 * 0.2f, num87);
					}
					else if (dust.type == 55 || dust.type == 56 || dust.type == 73 || dust.type == 74)
					{
						...
						if (!dust.noLightEmittence)
						{
							...
							if (dust.type == 55)
							{
								...
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num88, num88, num88 * 0.6f);
							}
							else if (dust.type == 73)
							{
								...
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num88, num88 * 0.35f, num88 * 0.5f);
							}
							else if (dust.type == 74)
							{
								...
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num88 * 0.35f, num88, num88 * 0.5f);
							}
							else
							{
								num88 = dust.scale * 1.2f;
								if (num88 > 1f)
								{
									num88 = 1f;
								}
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num88 * 0.35f, num88 * 0.5f, num88);
							}
						}
					}
					else if (dust.type == 71 || dust.type == 72)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num89 * 0.2f, 0f, num89 * 0.1f);
					}
					...
					if (dust.type == 35 && dust.noGravity)
					{
						...
						float num90 = dust.scale * 0.6f;
						if (num90 > 1f)
						{
							num90 = 1f;
						}
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f + 1f), num90, num90 * 0.3f, num90 * 0.1f);
					}
					...
					else if (dust.type == 67 || dust.type == 92)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), 0f, num91 * 0.8f, num91);
					}
					else if (dust.type == 185)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num92 * 0.1f, num92 * 0.7f, num92);
					}
					else if (dust.type == 107)
					{
						float num93 = dust.scale * 0.5f;
						if (num93 > 1f)
						{
							num93 = 1f;
						}
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num93 * 0.1f, num93, num93 * 0.4f);
					}
					else if (dust.type == 34 || dust.type == 35 || dust.type == 152)
					{
						...
						if (dust.type == 35)
						{
							float num94 = dust.scale * 0.3f + 0.4f;
							if (num94 > 1f)
							{
								num94 = 1f;
							}
					...
					if (dust.type == 68)
					{
						float num95 = dust.scale * 0.3f;
						if (num95 > 1f)
						{
							num95 = 1f;
						}
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num95 * 0.1f, num95 * 0.2f, num95);
					}
					if (dust.type == 70)
					{
						float num96 = dust.scale * 0.3f;
						if (num96 > 1f)
						{
							num96 = 1f;
						}
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num96 * 0.5f, 0f, num96);
					}
					if (dust.type == 41)
					{
						...
						dust.scale += 0.007f;
						float num97 = dust.scale * 0.7f;
						if (num97 > 1f)
						{
							num97 = 1f;
						}
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num97 * 0.4f, num97 * 0.9f, num97);
					}
					...
					if (dust.fadeIn > 0f && dust.fadeIn < 100f)
					{
						...
						{
							dust.scale += 0.007f;
							int num99 = (int)dust.fadeIn - 1;
							if (num99 >= 0 && num99 <= 255)
							{
								Vector2 value2 = dust.position - Main.player[num99].Center;
								float num100 = value2.Length();
								num100 = 100f - num100;
								if (num100 > 0f)
								{
									dust.scale -= num100 * 0.0015f;
								}
								value2.Normalize();
								float num101 = (1f - dust.scale) * 20f;
								value2 *= 0f - num101;
								dust.velocity = (dust.velocity * 4f + value2) / 5f;
							}
						}
					...
					if (dust.type >= 130 && dust.type <= 134)
					{
						...
						if (dust.type == 130)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num102 * 1f, num102 * 0.5f, num102 * 0.4f);
						}
						if (dust.type == 131)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num102 * 0.4f, num102 * 1f, num102 * 0.6f);
						}
						if (dust.type == 132)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num102 * 0.3f, num102 * 0.5f, num102 * 1f);
						}
						if (dust.type == 133)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num102 * 0.9f, num102 * 0.9f, num102 * 0.3f);
						}
						if (dust.noGravity)
						{
							dust.velocity *= 0.93f;
					...
					else if (dust.type == 226)
					{
						...
						if (!dust.noLight)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num105 * 0.2f, num105 * 0.7f, num105 * 1f);
						}
						if (dust.noGravity)
						{
							dust.velocity *= 0.93f;
					...
					else if (dust.type == 272)
					{
						...
						if (!dust.noLight)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num106 * 0.5f, num106 * 0.2f, num106 * 0.8f);
						}
						if (dust.noGravity)
						{
							dust.velocity *= 0.93f;
			...
			int num108 = num;
			if ((double)num108 > (double)Main.maxDustToDraw * 0.9)
			{
				dCount = 0.9f;
			}
			else if ((double)num108 > (double)Main.maxDustToDraw * 0.8)
			{
				dCount = 0.8f;
			}
			else if ((double)num108 > (double)Main.maxDustToDraw * 0.7)
			{
				dCount = 0.7f;
			}
			else if ((double)num108 > (double)Main.maxDustToDraw * 0.6)
			{
				dCount = 0.6f;
			}
			else if ((double)num108 > (double)Main.maxDustToDraw * 0.5)
			{
				dCount = 0.5f;
			}
			else
