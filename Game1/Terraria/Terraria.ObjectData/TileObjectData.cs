...
namespace Terraria.ObjectData
{
	public class TileObjectData
	{
		...
		private void SetupBaseObject()
		{
			...
			SubTiles = new List<TileObjectData>(623);
		...
		public static void Initialize()
		{
			...
			_data = new List<TileObjectData>(623);
			for (int i = 0; i < 623; i++)
			{
				_data.Add(null);
			}
			...
			newTile.AnchorInvalidTiles = new int[3]
			{
				127,
				138,
				484
			...
			newTile.StyleHorizontal = true;
			newTile.AnchorValidTiles = Utils.GetTrueIndexes(TileID.Sets.Conversion.Sand, TileID.Sets.Conversion.Sandstone, TileID.Sets.Conversion.HardenedSand).ToArray();
			addTile(485);
			newTile.CopyFrom(Style2x2);
			newTile.Origin = new Point16(0, 1);
			newTile.DrawYOffset = 2;
			...
			newTile.CoordinateWidth = 16;
			newTile.CoordinatePadding = 2;
			newTile.AnchorValidTiles = new int[5]
			{
				2,
				477,
				109,
