...
namespace Terraria.GameContent.ItemDropRules
{
	public class ItemDropDatabase
	{
		...
		private void RegisterBloodMoonFishing()
		{
			...
			RegisterToMultipleNPCs(ItemDropRule.OneFromOptions(8, 4273, 4381, 4325), 587, 586);
			...
			RegisterToNPC(618, ItemDropRule.Common(4269, 5));
			...
			RegisterToMultipleNPCs(ItemDropRule.ByCondition(condition, 4271, 200), 587, 586, 489, 490, 109, 621, 620);
			RegisterToMultipleNPCs(ItemDropRule.ByCondition(condition, 4271, 9), 53, 536, 618);
		}
		...
		private void RegisterBoss_LunarTowers()
		{
			...
			parameters.DropsXOutOfYTimes_TheX = 1;
			parameters.DropsXOutOfYTimes_TheY = 1;
		...
		private void RegisterMiscDrops()
		{
			...
			RegisterToNPC(120, ItemDropRule.NormalvsExpert(1326, 500, 400));
			RegisterToNPC(84, ItemDropRule.Common(4758, 35));
			...
			RegisterToNPC(44, ItemDropRule.Common(1320, 50));
			...
			RegisterToNPC(532, ItemDropRule.Common(3380, 3));
			...
			RegisterToNPC(481, ItemDropRule.OneFromOptions(20, 3187, 3188, 3189));
			...
			RegisterToNPC(44, ItemDropRule.Common(118, 25)).OnFailedRoll(ItemDropRule.OneFromOptions(20, 410, 411)).OnFailedRoll(ItemDropRule.Common(166, 1, 1, 3));
			...
			RegisterToNPC(39, ItemDropRule.ByCondition(new Conditions.WindyEnoughForKiteDrops(), 4610, 25));
			...
			IItemDropRule rule = leadingConditionRule.OnSuccess(ItemDropRule.OneFromOptions(20, options));
			int dropsOutOfY = 13;
			rule.OnSuccess(new CommonDrop(4367, dropsOutOfY));
			rule.OnSuccess(new CommonDrop(4368, dropsOutOfY));
			rule.OnSuccess(new CommonDrop(4369, dropsOutOfY));
			rule.OnSuccess(new CommonDrop(4370, dropsOutOfY));
			rule.OnSuccess(new CommonDrop(4371, dropsOutOfY));
			rule.OnSuccess(new CommonDrop(4612, dropsOutOfY));
			rule.OnSuccess(new CommonDrop(4674, dropsOutOfY));
			rule.OnSuccess(new CommonDrop(4343, dropsOutOfY, 1, 1, 3));
			rule.OnSuccess(new CommonDrop(4344, dropsOutOfY, 1, 1, 3));
