...
namespace Terraria.Utilities
{
	public static class CrashDump
	{
		...
		private static bool Write(SafeHandle fileHandle, Options options, ExceptionInfo exceptionInfo)
		{
			...
			return MiniDumpWriteDump(handle, id, fileHandle, (uint)options, expParam, IntPtr.Zero, IntPtr.Zero);
		}
		...
		private static extern bool MiniDumpWriteDump(IntPtr hProcess, uint processId, SafeHandle hFile, uint dumpType, MiniDumpExceptionInformation expParam, IntPtr userStreamParam, IntPtr callbackParam);
