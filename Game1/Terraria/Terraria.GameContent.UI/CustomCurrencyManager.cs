...
namespace Terraria.GameContent.UI
{
	public class CustomCurrencyManager
	{
		...
		public static void GetPriceText(int currencyIndex, string[] lines, int currentLine, int price)
		{
			_currencies[currencyIndex].GetPriceText(lines, currentLine, price);
		}
