...
namespace Terraria.GameContent.Skies
{
	public class SolarSky : CustomSky
	{
		...
		{
			_planetTexture = Main.Assets.Request<Texture2D>("Images/Misc/SolarSky/Planet", Main.content, (AssetRequestMode)1);
			_bgTexture = Main.Assets.Request<Texture2D>("Images/Misc/SolarSky/Background", Main.content, (AssetRequestMode)1);
			_meteorTexture = Main.Assets.Request<Texture2D>("Images/Misc/SolarSky/Meteor", Main.content, (AssetRequestMode)1);
		}
