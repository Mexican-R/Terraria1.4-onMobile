	...
	public class AmbientSky : CustomSky
	{
		private abstract class SkyEntity
		{
			...
			protected void SetPositionInWorldBasedOnScreenSpace(Vector2 actualWorldSpace)
			{
				...
				Vector2 vector = (Position = Main.Camera.Center + value * (Depth / 3f));
			}
		...
		private class ButterfliesSkyEntity : FadingSkyEntity
		{
			public ButterfliesSkyEntity(Player player, FastRandom random)
			{
				...
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/ButterflySwarm" + num2, Main.content, (AssetRequestMode)1);
		...
		private class LostKiteSkyEntity : FadingSkyEntity
		{
			public LostKiteSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 3f;
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/LostKite", Main.content, (AssetRequestMode)1);
		...
		private class PegasusSkyEntity : FadingSkyEntity
		{
			public PegasusSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 3f;
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Pegasus", Main.content, (AssetRequestMode)1);
		...
		private class VultureSkyEntity : FadingSkyEntity
		{
			public VultureSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 3f;
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Vulture", Main.content, (AssetRequestMode)1);
		...
		private class PixiePosseSkyEntity : FadingSkyEntity
		{
			...
			public PixiePosseSkyEntity(Player player, FastRandom random)
			{
				...
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/PixiePosse" + pixieType, Main.content, (AssetRequestMode)1);
		...
		private class BirdsPackSkyEntity : FadingSkyEntity
		{
			public BirdsPackSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 3f;
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/BirdsVShape", Main.content, (AssetRequestMode)1);
		...
		private class SeagullsGroupSkyEntity : FadingSkyEntity
		{
			...
			public SeagullsGroupSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 3f;
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Seagull", Main.content, (AssetRequestMode)1);
		...
		private class GastropodGroupSkyEntity : FadingSkyEntity
		{
			...
			public GastropodGroupSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 2f;
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Gastropod", Main.content, (AssetRequestMode)1);
		...
		private class SlimeBalloonGroupSkyEntity : FadingSkyEntity
		{
			...
			public SlimeBalloonGroupSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 3f;
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/SlimeBalloons", Main.content, (AssetRequestMode)1);
		...
		private class HellBatsGoupSkyEntity : FadingSkyEntity
		{
			...
			public HellBatsGoupSkyEntity(Player player, FastRandom random)
			{
				...
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/HellBat" + random.Next(1, 3), Main.content, (AssetRequestMode)1);
				Frame = new SpriteFrame(1, 10);
				LifeTime = random.Next(60, 121) * 60;
				OpacityNormalizedTimeToFadeIn = 0.1f;
				OpacityNormalizedTimeToFadeOut = 0.9f;
			...
			public override Color GetColor(Color backgroundColor)
			{
				return Color.Lerp(Color.White, Color.Gray, Depth / 15f) * Opacity * FinalOpacityMultiplier;
			}
		...
		private class BatsGroupSkyEntity : FadingSkyEntity
		{
			...
			public BatsGroupSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 3f;
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Bat" + random.Next(1, 4), Main.content, (AssetRequestMode)1);
				Frame = new SpriteFrame(1, 10);
				LifeTime = random.Next(60, 121) * 60;
				OpacityNormalizedTimeToFadeIn = 0.1f;
				OpacityNormalizedTimeToFadeOut = 0.9f;
		...
		private class WyvernSkyEntity : FadingSkyEntity
		{
			public WyvernSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 3f;
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Wyvern", Main.content, (AssetRequestMode)1);
		...
		private class AirshipSkyEntity : FadingSkyEntity
		{
			public AirshipSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 3f;
				SetPositionInWorldBasedOnScreenSpace(Position);
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/FlyingShip", Main.content, (AssetRequestMode)1);
				Frame = new SpriteFrame(1, 4);
				LifeTime = random.Next(40, 71) * 60;
		...
		private class AirBalloonSkyEntity : FadingSkyEntity
		{
			...
			public AirBalloonSkyEntity(Player player, FastRandom random)
			{
				...
				Depth = random.NextFloat() * 3f + 3f;
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/AirBalloons_" + ((random.Next(2) == 0) ? "Large" : "Small"), Main.content, (AssetRequestMode)1);
				Frame = new SpriteFrame(1, 5);
		...
		private class CrimeraSkyEntity : EOCSkyEntity
		{
				...
				: base(player, random)
			{
				...
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Crimera" + num, Main.content, (AssetRequestMode)1);
		...
		private class EOSSkyEntity : EOCSkyEntity
		{
				...
				: base(player, random)
			{
				...
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/EOS" + num, Main.content, (AssetRequestMode)1);
				Frame = new SpriteFrame(1, 4);
			}
		...
		private class EOCSkyEntity : FadingSkyEntity
		{
			...
			public EOCSkyEntity(Player player, FastRandom random)
			{
				...
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/EOC", Main.content, (AssetRequestMode)1);
				Frame = new SpriteFrame(1, 3);
				Depth = random.NextFloat() * 3f + 4.5f;
				if (random.Next(4) != 0)
				{
					BeginZigZag(random, camera, (random.Next(2) == 1) ? 1 : (-1));
				}
				else
				{
					BeginChasingPlayer(random, camera);
				}
				SetPositionInWorldBasedOnScreenSpace(Position);
				OpacityNormalizedTimeToFadeIn = 0.1f;
				OpacityNormalizedTimeToFadeOut = 0.9f;
		...
		private class MeteorSkyEntity : FadingSkyEntity
		{
			public MeteorSkyEntity(Player player, FastRandom random)
			{
				...
				Effects = ((random.Next(2) != 0) ? SpriteEffects.FlipHorizontally : SpriteEffects.None);
				Depth = random.NextFloat() * 3f + 3f;
				Texture = Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Meteor", Main.content, (AssetRequestMode)1);
				Frame = new SpriteFrame(1, 4);
				Vector2 value = ((float)Math.PI / 4f + random.NextFloat() * ((float)Math.PI / 2f)).ToRotationVector2();
				float num = (float)(Main.worldSurface * 16.0 - 0.0) / value.Y;
				float num2 = 1200f;
				float scaleFactor = num / num2;
				Vector2 vector = (Velocity = value * scaleFactor);
				int num3 = 100;
				Vector2 vector2 = (Position = player.Center + new Vector2(random.Next(-num3, num3 + 1), random.Next(-num3, num3 + 1)) - Velocity * num2 * 0.5f);
				LifeTime = (int)num2;
				OpacityNormalizedTimeToFadeIn = 0.05f;
				OpacityNormalizedTimeToFadeOut = 0.95f;
		...
		public override void Update(GameTime gameTime)
		{
			...
			foreach (SlotVector<SkyEntity>.ItemPair item in (SlotVector<SkyEntity>)_entities)
			{
