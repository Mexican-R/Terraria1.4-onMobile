...
namespace Terraria.GameContent.Skies
{
	public class MartianSky : CustomSky
	{
		...
		{
			public abstract void InitializeUfo(Ufo ufo);

			public abstract bool Update(Ufo ufo);
		}
		...
		private class ZipBehavior : IUfoController
		{
			...
			public override void InitializeUfo(Ufo ufo)
			{
			...
			public override bool Update(Ufo ufo)
			{
				if (_ticks < 10)
				{
					ufo.Opacity += 0.1f;
