...
namespace Terraria.GameContent.UI.Elements
{
	public class UIPanel : UIElement
	{
		...
		public UIPanel()
		{
			...
			{
				_borderTexture = Main.Assets.Request<Texture2D>("Images/UI/PanelBorder", Main.content, (AssetRequestMode)1);
			}
			if (_backgroundTexture == null)
			{
				_backgroundTexture = Main.Assets.Request<Texture2D>("Images/UI/PanelBackground", Main.content, (AssetRequestMode)1);
			}
