...
namespace Terraria.GameContent.UI.Elements
{
	public class UIWorldCreationPreview : UIElement
	{
		...
		{
			_BorderTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewBorder", Main.content, (AssetRequestMode)1);
			_BackgroundNormalTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewDifficultyNormal1", Main.content, (AssetRequestMode)1);
			_BackgroundExpertTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewDifficultyExpert1", Main.content, (AssetRequestMode)1);
			_BackgroundMasterTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewDifficultyMaster1", Main.content, (AssetRequestMode)1);
			_BunnyNormalTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewDifficultyNormal2", Main.content, (AssetRequestMode)1);
			_BunnyExpertTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewDifficultyExpert2", Main.content, (AssetRequestMode)1);
			_BunnyCreativeTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewDifficultyCreative2", Main.content, (AssetRequestMode)1);
			_BunnyMasterTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewDifficultyMaster2", Main.content, (AssetRequestMode)1);
			_EvilRandomTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewEvilRandom", Main.content, (AssetRequestMode)1);
			_EvilCorruptionTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewEvilCorruption", Main.content, (AssetRequestMode)1);
			_EvilCrimsonTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewEvilCrimson", Main.content, (AssetRequestMode)1);
			_SizeSmallTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewSizeSmall", Main.content, (AssetRequestMode)1);
			_SizeMediumTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewSizeMedium", Main.content, (AssetRequestMode)1);
			_SizeLargeTexture = Main.Assets.Request<Texture2D>("Images/UI/WorldCreation/PreviewSizeLarge", Main.content, (AssetRequestMode)1);
