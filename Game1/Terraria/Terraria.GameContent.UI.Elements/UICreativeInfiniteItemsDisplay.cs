...
namespace Terraria.GameContent.UI.Elements
{
	public class UICreativeInfiniteItemsDisplay : UIElement
	{
		...
		private void AddCogsForSacrificeMenu(UIElement sacrificesContainer)
		{
			...
			AddSymetricalCogsPair(uIElement, new Vector2(22f, 1f) + value, "Images/UI/Creative/Research_GearC", _sacrificeCogsSmall);
			AddSymetricalCogsPair(uIElement, new Vector2(1f, 28f) + value, "Images/UI/Creative/Research_GearB", _sacrificeCogsMedium);
			AddSymetricalCogsPair(uIElement, new Vector2(5f, 5f) + value, "Images/UI/Creative/Research_GearA", _sacrificeCogsBig);
		}
		...
		{
			Asset<Texture2D> val = Main.Assets.Request<Texture2D>(assetPath, Main.content, (AssetRequestMode)1);
