...
namespace Terraria.GameContent.UI.Elements
{
	public class UIScrollbar : UIElement
	{
		...
		public UIScrollbar()
		{
			Width.Set(20f, 0f);
			MaxWidth.Set(20f, 0f);
			_texture = Main.Assets.Request<Texture2D>("Images/UI/Scrollbar", Main.content, (AssetRequestMode)1);
			_innerTexture = Main.Assets.Request<Texture2D>("Images/UI/ScrollbarInner", Main.content, (AssetRequestMode)1);
			PaddingTop = 5f;
			PaddingBottom = 5f;
		}
