...
namespace Terraria.GameContent.UI.Elements
{
	public class UIAchievementListItem : UIPanel
	{
		...
		public UIAchievementListItem(Achievement achievement, bool largeForOtherLanguages)
		{
			...
			UpdateIconFrame();
			_achievementIcon = new UIImageFramed(Main.Assets.Request<Texture2D>("Images/UI/Achievements", Main.content, (AssetRequestMode)1), _iconFrame);
			_achievementIcon.Left.Set(num2, 0f);
			_achievementIcon.Top.Set(num3, 0f);
			Append(_achievementIcon);
			_achievementIconBorders = new UIImage(Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders", Main.content, (AssetRequestMode)1));
			_achievementIconBorders.Left.Set(-4f + num2, 0f);
			_achievementIconBorders.Top.Set(-4f + num3, 0f);
			Append(_achievementIconBorders);
			_innerPanelTopTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievement_InnerPanelTop", Main.content, (AssetRequestMode)1);
			if (_large)
			{
				_innerPanelBottomTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievement_InnerPanelBottom_Large", Main.content, (AssetRequestMode)1);
			}
			else
			{
				_innerPanelBottomTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievement_InnerPanelBottom", Main.content, (AssetRequestMode)1);
			}
			_categoryTexture = Main.Assets.Request<Texture2D>("Images/UI/Achievement_Categories", Main.content, (AssetRequestMode)1);
		}
