...
namespace Terraria.GameContent.UI.Elements
{
	public class UIHorizontalSeparator : UIElement
	{
		...
		public UIHorizontalSeparator(int EdgeWidth = 2, bool highlightSideUp = true)
		{
			...
			if (highlightSideUp)
			{
				_texture = Main.Assets.Request<Texture2D>("Images/UI/CharCreation/Separator1", Main.content, (AssetRequestMode)1);
			}
			else
			{
				_texture = Main.Assets.Request<Texture2D>("Images/UI/CharCreation/Separator2", Main.content, (AssetRequestMode)1);
			}
