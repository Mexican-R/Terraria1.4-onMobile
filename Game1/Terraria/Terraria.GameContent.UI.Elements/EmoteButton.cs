...
namespace Terraria.GameContent.UI.Elements
{
	public class EmoteButton : UIElement
	{
		...
		{
			_texture = Main.Assets.Request<Texture2D>("Images/Extra_" + (short)48, Main.content, (AssetRequestMode)1);
			_textureBorder = Main.Assets.Request<Texture2D>("Images/UI/EmoteBubbleBorder", Main.content, (AssetRequestMode)1);
		...
		private Rectangle GetFrame()
		{
			...
			return _texture.Frame(8, 38, _emoteIndex % 4 * 2 + num, _emoteIndex / 4 + 1);
		}
