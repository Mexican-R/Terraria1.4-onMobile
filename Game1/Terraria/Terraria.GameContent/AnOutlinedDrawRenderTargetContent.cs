...
namespace Terraria.GameContent
{
	public abstract class AnOutlinedDrawRenderTargetContent : ARenderTargetContentByRequest
	{
		...
		protected override void HandleUseReqest(GraphicsDevice device, SpriteBatch spriteBatch)
		{
			...
			PrepareARenderTarget_AndListenToEvents(_target, device, width, height, RenderTargetUsage.PreserveContents);
			PrepareARenderTarget_WithoutListeningToEvents(_helperTarget, device, width, height, RenderTargetUsage.DiscardContents);
