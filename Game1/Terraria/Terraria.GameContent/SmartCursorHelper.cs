	...
	public class SmartCursorHelper
	{
		...
		public static void SmartCursorLookup(Player player)
		{
			...
			if (!num || smartCursorUsageInfo.screenTargetX < smartCursorUsageInfo.reachableStartX || smartCursorUsageInfo.screenTargetX > smartCursorUsageInfo.reachableEndX || smartCursorUsageInfo.screenTargetY < smartCursorUsageInfo.reachableStartY || smartCursorUsageInfo.screenTargetY > smartCursorUsageInfo.reachableEndY)
			{
				...
				{
					Step_Axe(smartCursorUsageInfo, fX, fY);
				}
				Step_ForceCursorToAnyMinableThing(smartCursorUsageInfo, fX, fY);
				Step_Pickaxe_MineShinies(smartCursorUsageInfo, fX, fY);
				Step_Pickaxe_MineSolids(player, smartCursorUsageInfo, _grappleTargets, fX, fY);
				if (Player.SmartCursorSettings.SmartAxeAfterPickaxe)
				{
					Step_Axe(smartCursorUsageInfo, fX, fY);
				}
				Step_ColoredWrenches(smartCursorUsageInfo, fX, fY);
				Step_MulticolorWrench(smartCursorUsageInfo, fX, fY);
				Step_Hammers(smartCursorUsageInfo, fX, fY);
				Step_ActuationRod(smartCursorUsageInfo, fX, fY);
				Step_WireCutter(smartCursorUsageInfo, fX, fY);
				Step_Platforms(smartCursorUsageInfo, fX, fY);
				Step_MinecartTracks(smartCursorUsageInfo, fX, fY);
				Step_Walls(smartCursorUsageInfo, fX, fY);
				Step_PumpkinSeeds(smartCursorUsageInfo, fX, fY);
				Step_Pigronata(smartCursorUsageInfo, fX, fY);
				Step_Boulders(smartCursorUsageInfo, fX, fY);
				Step_Torch(smartCursorUsageInfo, fX, fY);
				Step_LawnMower(smartCursorUsageInfo, fX, fY);
				Step_BlocksFilling(smartCursorUsageInfo, fX, fY);
				Step_BlocksLines(smartCursorUsageInfo, fX, fY);
				Step_PaintRoller(smartCursorUsageInfo, fX, fY);
				Step_PaintBrush(smartCursorUsageInfo, fX, fY);
				Step_PaintScrapper(smartCursorUsageInfo, fX, fY);
				Step_Acorns(smartCursorUsageInfo, fX, fY);
				Step_GemCorns(smartCursorUsageInfo, fX, fY);
				Step_EmptyBuckets(smartCursorUsageInfo, fX, fY);
				Step_Actuators(smartCursorUsageInfo, fX, fY);
				Step_AlchemySeeds(smartCursorUsageInfo, fX, fY);
				Step_PlanterBox(smartCursorUsageInfo, fX, fY);
				Step_ClayPots(smartCursorUsageInfo, fX, fY);
				Step_StaffOfRegrowth(smartCursorUsageInfo, fX, fY);
				if (fX != -1 && fY != -1)
				{
		...
		private static void Step_StaffOfRegrowth(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_ClayPots(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_PlanterBox(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_AlchemySeeds(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
			...
			for (int i = providedInfo.reachableStartX; i <= providedInfo.reachableEndX; i++)
			{
				for (int j = providedInfo.reachableStartY; j <= providedInfo.reachableEndY; j++)
				{
					Tile tile = Main.tile[i, j];
					Tile tile2 = Main.tile[i, j + 1];
					bool num = !tile.active() || TileID.Sets.BreakableWhenPlacing[tile.type] || (Main.tileCut[tile.type] && tile.type != 82 && WorldGen.IsHarvestableHerbWithSeed(tile.type, tile.frameX / 18));
		...
		private static void Step_Actuators(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_EmptyBuckets(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_PaintScrapper(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_PaintBrush(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_PaintRoller(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_BlocksLines(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_Boulders(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_Pigronata(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_PumpkinSeeds(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_Walls(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_MinecartTracks(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_Platforms(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_WireCutter(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_ActuationRod(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_Hammers(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
			int width = providedInfo.player.width;
			int height = providedInfo.player.height;
		...
		private static void Step_MulticolorWrench(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_ColoredWrenches(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_Acorns(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_GemCorns(SmartCursorUsageInfo providedInfo, int focusedX, int focusedY)
		{
		...
		private static void Step_ForceCursorToAnyMinableThing(SmartCursorUsageInfo providedInfo, int fX, int fY)
		{
		...
		private static void Step_Pickaxe_MineShinies(SmartCursorUsageInfo providedInfo, int fX, int fY)
		{
			int reachableStartX = providedInfo.reachableStartX;
			int reachableStartY = providedInfo.reachableStartY;
			int reachableEndX = providedInfo.reachableEndX;
		...
		private static void Step_Pickaxe_MineSolids(Player player, SmartCursorUsageInfo providedInfo, List<Tuple<int, int>> grappleTargets, int focusedX, int focusedY)
		{
			...
			int num10 = width / 16 + ((width % 16 != 0) ? 1 : 0);
			int num11 = height / 16 + ((height % 16 != 0) ? 1 : 0);
			if (WorldGen.InWorld(num8, num9, Main.Map.BlackEdgeWidth))
			{
				if (num != 0)
				{
					for (int k = 0; k < num11; k++)
		...
		private static void Step_Axe(SmartCursorUsageInfo providedInfo, int fX, int fY)
		{
			int reachableStartX = providedInfo.reachableStartX;
			int reachableStartY = providedInfo.reachableStartY;
			int reachableEndX = providedInfo.reachableEndX;
		...
		private static void Step_BlocksFilling(SmartCursorUsageInfo providedInfo, int fX, int fY)
		{
		...
		private static void Step_Torch(SmartCursorUsageInfo providedInfo, int fX, int fY)
		{
			int reachableStartX = providedInfo.reachableStartX;
			int reachableStartY = providedInfo.reachableStartY;
			int reachableEndX = providedInfo.reachableEndX;
		...
		private static void Step_LawnMower(SmartCursorUsageInfo providedInfo, int fX, int fY)
		{
			int reachableStartX = providedInfo.reachableStartX;
			int reachableStartY = providedInfo.reachableStartY;
			int reachableEndX = providedInfo.reachableEndX;
