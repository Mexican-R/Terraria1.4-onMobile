...
namespace Terraria.GameContent
{
	public class TilePaintSystemV2
	{
		...
		public class TreeTopRenderTargetHolder : ARenderTargetHolder
		{
			...
			{
				Asset<Texture2D> val = Main.Assets.Request<Texture2D>(TextureAssets.TreeTop[Key.TextureIndex].Name, Main.content, (AssetRequestMode)1);
		...
		public class TreeBranchTargetHolder : ARenderTargetHolder
		{
			...
			public override void Prepare()
			{
				Asset<Texture2D> val = Main.Assets.Request<Texture2D>(TextureAssets.TreeBranch[Key.TextureIndex].Name, Main.content, (AssetRequestMode)1);
				PrepareTextureIfNecessary(val.Value);
			}
		...
		public class TileRenderTargetHolder : ARenderTargetHolder
		{
			...
			public override void Prepare()
			{
				Asset<Texture2D> val = Main.Assets.Request<Texture2D>(TextureAssets.Tile[Key.TileType].Name, Main.content, (AssetRequestMode)1);
				PrepareTextureIfNecessary(val.Value);
			}
		...
		public class WallRenderTargetHolder : ARenderTargetHolder
		{
			...
			public override void Prepare()
			{
				Asset<Texture2D> val = Main.Assets.Request<Texture2D>(TextureAssets.Wall[Key.WallType].Name, Main.content, (AssetRequestMode)1);
				PrepareTextureIfNecessary(val.Value);
			}
		...
		public void RequestTile(TileVariationkey lookupKey)
		{
		...
		private void RequestTile_CheckForRelatedTileRequests(TileVariationkey lookupKey)
		{
			if (lookupKey.TileType == 83)
			{
				...
				RequestTile(lookupKey2);
			}
		}

		public void RequestWall(WallVariationKey lookupKey)
		{
		...
		public void RequestTreeTop(TreeFoliageVariantKey lookupKey)
		{
		...
		public void RequestTreeBranch(TreeFoliageVariantKey lookupKey)
		{
